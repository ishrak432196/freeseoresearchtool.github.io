                ...
                <!-- form start -->
                 ...
                 <div class="box-header"> <br />
                    <h3 class="box-title">License Verification</h3>
                        ...
                        <div class="form-group">
                                            <label for="data_sec">Item Purchase Code</label>
                                            <input style="border-color: #DDDDDD;" type="text" value="Aleem-Rocked-Script-Shocked" name="data_sec" id="data_sec" class="form-control" disabled="disabled">
                                        </div>
                    </div><!-- /.box-body -->
    ...
    <br />  
     ...
     <!-- Main Footer -->
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2019 <a href="http://prothemes.biz/">ProThemes.Biz</a></strong> All rights reserved.
      </footer>
